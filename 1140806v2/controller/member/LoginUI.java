...
public class LoginUI extends JFrame {
	...
	public LoginUI() {
		...
		loginButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if(memberLogin!=null)
				{
					...
					CustMemberShopUI frame = new CustMemberShopUI();
					frame.setVisible(true);
					dispose();
				}else {
		...
		loginButton.setBounds(24, 120, 87, 23);
		...
		newMemberButton.setBounds(140, 120, 87, 23);
		...
		bossButton.setBounds(10, 153, 116, 23);
